  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Information System: Streamlining your HR tasks by offering a comprehensive platform for managing employee data, vacations, and payroll efficiently."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Information System: Streamlining your HR tasks by offering a comprehensive platform for managing employee data, vacations, and payroll efficiently.`}
            </Text>
            <Box
